...
func TestNetStnGetPod_A001(t *testing.T) {
	cs := testclient.NewSimpleClientset()
	input := &appv1.Pod{ObjectMeta: metav1.ObjectMeta{Name: "unit-test-pod"}}
	...
	err = options.KubectlNetStn("unit-test-pod1", "debug", false)
	if err == nil {
		t.Errorf("Error during reterving pod that doesn't exist")
	}
}
...
func TestNetStngerName_A001(t *testing.T) {
	cs := testclient.NewSimpleClientset()
	input := &appv1.Pod{ObjectMeta: metav1.ObjectMeta{Name: "unit-test-pod"}}
	...
	err = options.KubectlNetStn("unit-test-pod", "hello", false)
	if err == nil {
		t.Errorf("Error while using illegal loggerName")
	}
}
...
func TestNetStngerName_A002(t *testing.T) {
	cs := testclient.NewSimpleClientset()
	input := &appv1.Pod{ObjectMeta: metav1.ObjectMeta{Name: "unit-test-pod"}}
	...
	err = options.KubectlNetStn("unit-test-pod", "debug", false)
...
func TestNetStngerLevel_A001(t *testing.T) {
	cs := testclient.NewSimpleClientset()
	input := &appv1.Pod{ObjectMeta: metav1.ObjectMeta{Name: "unit-test-pod"}}
	...
	err = options.KubectlNetStn("unit-test-pod", "debug:hello", false)
	if err == nil {
		t.Errorf("Error while using illegal loggerLevel")
	}
}

func TestNetStngerLevel_A002(t *testing.T) {
	cs := testclient.NewSimpleClientset()
	input := &appv1.Pod{ObjectMeta: metav1.ObjectMeta{Name: "unit-test-pod"}}
	...
	err = options.KubectlNetStn("unit-test-pod", "http:debug", false)
	if !successfullyParsedLoggerNameAndLevel(err) {
		t.Errorf("Error while using illegal loggerName")
	}
}
